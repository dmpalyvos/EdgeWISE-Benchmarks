...
public class SampleTimerSpoutForTrain extends BaseRichSpout implements ISyntheticEventGen {
	...
	public SampleTimerSpoutForTrain() {
	...
	public SampleTimerSpoutForTrain(String csvFileName, String outSpoutCSVLogFileName, double scalingFactor,
			String experiRunId) {
